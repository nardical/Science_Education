...
_BEGINNER_MATTER = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_solid_splash", "scene": "solid_or_splash", "picture": "💦",
                "question": "Which one can splash?",
                "left_name": "Water", "right_name": "Wood block",
                "left_pic": "💦", "right_pic": "🧱",
                "left_move": "splash", "right_move": "still",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_hot_cold", "scene": "hot_or_cold", "picture": "🧊",
                "question": "Which one feels cold?",
                "left_name": "Ice cube", "right_name": "Warm soup",
                "left_pic": "🧊", "right_pic": "🍲",
                "left_move": "shiver", "right_move": "steam",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_melt", "scene": "melt_or_freeze", "picture": "🌡️",
                "question": "Ice warms. What happens?",
                "stuff": "Ice", "stuff_pic": "🧊", "action": "melt",
            },
            look_pose="play",
        ),
    ],
...
_BEGINNER_LIVING = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_living_or_not", "scene": "living_or_not", "picture": "🐶",
                "question": "Which one is living?",
                "left_name": "Puppy", "right_name": "Toy car",
                "left_pic": "🐶", "right_pic": "🚗",
                "left_move": "bob", "right_move": "still",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_plant_animal", "scene": "plant_or_animal", "picture": "🌻",
                "question": "Which one is a plant?",
                "left_name": "Sunflower", "right_name": "Rabbit",
                "left_pic": "🌻", "right_pic": "🐇",
                "left_move": "grow", "right_move": "hop",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_hungry", "scene": "hungry_or_full", "picture": "🐦",
                "question": "What does the hungry bird need?",
                "left_name": "Food", "right_name": "A toy",
                "left_pic": "🪱", "right_pic": "🧸",
                "left_move": "bob", "right_move": "still",
            },
            look_pose="play",
...
_BEGINNER_STEPS = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_first_next", "scene": "first_then_next", "picture": "🧦",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_missing", "scene": "missing_step", "picture": "🧼",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_repeat", "scene": "do_it_again", "picture": "🔁",
                "question": "Repeat means what?",
                "action": "Clap", "action_pic": "👏",
            },
            look_pose="play",
        ),
    ],
...
_INTERMEDIATE_MOTION = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_farther", "scene": "who_went_farther", "picture": "🏁",
                "question": "Which car went farther?",
                "near_name": "Blue car", "far_name": "Red car",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_speeding", "scene": "speeding_up", "picture": "🚙",
                "question": "The gaps grow. What happens?",
                "vehicle": "Race car", "gaps": "grow",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_downhill", "scene": "roll_downhill", "picture": "⚽",
                "question": "Which way will the ball roll?",
                "ball": "Soccer ball", "ball_pic": "⚽",
            },
            look_pose="play",
        ),
    ],
...
_INTERMEDIATE_FORCES = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_balance", "scene": "compare", "picture": "⚖️",
                "question": "Who sits near the middle?",
                "left_name": "Heavy bear", "right_name": "Light bunny",
                "left_pic": "🐻", "right_pic": "🐰",
                "left_move": "still", "right_move": "bob",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_slide", "scene": "compare", "picture": "📦",
                "question": "Which floor lets the box slide?",
                "left_name": "Smooth tile", "right_name": "Sandpaper",
                "left_pic": "⬜", "right_pic": "🧻",
                "left_move": "slide", "right_move": "still",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_stronger", "scene": "compare", "picture": "💪",
                "question": "Which push wins?",
                "left_name": "Big push", "right_name": "Small push",
                "left_pic": "💪", "right_pic": "👆",
                "left_move": "slide", "right_move": "wiggle",
            },
            look_pose="play",
        ),
    ],
...
_INTERMEDIATE_LIGHT = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_shadow", "scene": "compare", "picture": "🔦",
                "question": "What makes a shadow?",
                "left_name": "Toy", "right_name": "Empty air",
                "left_pic": "🧸", "right_pic": "✨",
                "left_move": "still", "right_move": "wiggle",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_louder", "scene": "compare", "picture": "〰️",
                "question": "Which wave looks louder?",
                "left_name": "Big wave", "right_name": "Tiny wave",
                "left_pic": "〰️", "right_pic": "·",
                "left_move": "wiggle", "right_move": "still",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_echo", "scene": "compare", "picture": "🗣️",
                "question": "Where will you hear an echo?",
                "left_name": "Empty cave", "right_name": "Pillow pile",
                "left_pic": "🕳️", "right_pic": "🛏️",
                "left_move": "wiggle", "right_move": "still",
            },
            look_pose="play",
        ),
...
_INTERMEDIATE_MATTER = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_ice_water", "scene": "compare", "picture": "🧊",
                "question": "Which one turns to water?",
                "left_name": "Ice in sun", "right_name": "Ice in freezer",
                "left_pic": "🧊", "right_pic": "❄️",
                "left_move": "splash", "right_move": "still",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_same_stuff", "scene": "compare", "picture": "🍫",
                "question": "Which pair is the same stuff?",
                "left_name": "Ice and water", "right_name": "Ice and juice",
                "left_pic": "🧊", "right_pic": "🧃",
                "left_move": "splash", "right_move": "still",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_mix", "scene": "compare", "picture": "🥛",
                "question": "Which mix settles apart?",
                "left_name": "Sand and water", "right_name": "Sugar and water",
                "left_pic": "🏖️", "right_pic": "🍬",
                "left_move": "still", "right_move": "splash",
            },
            look_pose="play",
        ),
    ],
...
_INTERMEDIATE_LIVING = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_needs", "scene": "compare", "picture": "🌱",
                "question": "What helps this living thing grow?",
                "left_name": "Water", "right_name": "Plastic beads",
                "left_pic": "💧", "right_pic": "🔵",
                "left_move": "splash", "right_move": "still",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_eats", "scene": "compare", "picture": "🐇",
                "question": "What should it eat?",
                "left_name": "Grass", "right_name": "Pebbles",
                "left_pic": "🌱", "right_pic": "🪨",
                "left_move": "grow", "right_move": "still",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_home", "scene": "compare", "picture": "🐟",
                "question": "Where does it belong?",
                "left_name": "Pond", "right_name": "Dry sandbox",
                "left_pic": "🐟", "right_pic": "🏖️",
                "left_move": "bob", "right_move": "still",
            },
            look_pose="play",
...
_INTERMEDIATE_MAKE = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_bridge_test", "scene": "compare", "picture": "🌉",
                "question": "Which test checks the bridge?",
                "left_name": "Add toy cars", "right_name": "Paint it",
                "left_pic": "🚗", "right_pic": "🎨",
                "left_move": "bob", "right_move": "still",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_fix_ramp", "scene": "compare", "picture": "🏎️",
                "question": "What should change to help the car?",
                "left_name": "Steep ramp", "right_name": "Flat ramp",
                "left_pic": "🛝", "right_pic": "➖",
                "left_move": "slide", "right_move": "still",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_predict", "scene": "compare", "picture": "🔬",
                "question": "What comes after predict?",
                "left_name": "Test it", "right_name": "Forget it",
                "left_pic": "🔬", "right_pic": "🙈",
                "left_move": "bob", "right_move": "still",
            },
            look_pose="play",
...
_INTERMEDIATE_STEPS = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_robot", "scene": "first_then_next", "picture": "🤖",
                "question": "Forward, turn, then what?",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_if_red", "scene": "first_then_next", "picture": "🚦",
                "question": "The light turns red. Do what?",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_repeat3", "scene": "do_it_again", "picture": "🔁",
                "question": "Tap repeats three times. How many taps?",
                "action": "Tap", "action_pic": "👆",
            },
            look_pose="play",
        ),
    ],
...
_ADVANCED_MOTION = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_steeper", "scene": "compare", "picture": "🛝",
                "question": "Which ramp makes more speed?",
                "left_name": "Steep ramp", "right_name": "Flat ramp",
                "left_pic": "🛝", "right_pic": "➖",
                "left_move": "slide", "right_move": "still",
            },
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_two_pushes", "scene": "compare", "picture": "➡️",
                "question": "Which way do the pushes add?",
                "left_name": "Two right pushes", "right_name": "One left push",
                "left_pic": "➡️➡️", "right_pic": "⬅️",
                "left_move": "slide", "right_move": "still",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_clock", "scene": "compare", "picture": "⏱️",
                "question": "Same trip. Who is faster?",
                "left_name": "3-second car", "right_name": "6-second car",
                "left_pic": "🚗", "right_pic": "🚙",
                "left_move": "slide", "right_move": "still",
            },
            look_pose="play",
...
_ADVANCED_FORCES = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_fair", "scene": "compare", "picture": "⚖️",
                "question": "What keeps both sides even?",
                "left_name": "Equal weights", "right_name": "One heavy side",
                "left_pic": "⚖️", "right_pic": "🏋️",
                "left_move": "still", "right_move": "wiggle",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_rough", "scene": "compare", "picture": "🏎️",
                "question": "Which ramp lets the car go farther?",
                "left_name": "Smooth ramp", "right_name": "Rough ramp",
                "left_pic": "🪵", "right_pic": "🧻",
                "left_move": "slide", "right_move": "still",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_lever", "scene": "compare", "picture": "🪵",
                "question": "Where should the pivot go?",
                "left_name": "Pivot near the rock", "right_name": "Pivot near your hand",
                "left_pic": "🪨", "right_pic": "✋",
                "left_move": "still", "right_move": "wiggle",
            },
            look_pose="play",
...
_ADVANCED_LIGHT = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_big_shadow", "scene": "compare", "picture": "⬛",
                "question": "Which makes the bigger shadow?",
                "left_name": "Big block", "right_name": "Small block",
                "left_pic": "⬛", "right_pic": "▪️",
                "left_move": "grow", "right_move": "still",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_pitch", "scene": "compare", "picture": "🎵",
                "question": "Which note has the highest pitch?",
                "left_name": "Tiny bell", "right_name": "Floor drum",
                "left_pic": "🔔", "right_pic": "🥁",
                "left_move": "wiggle", "right_move": "still",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_blocked", "scene": "compare", "picture": "🧱",
                "question": "What blocks the light?",
                "left_name": "Wall", "right_name": "Open door",
                "left_pic": "🧱", "right_pic": "🚪",
                "left_move": "still", "right_move": "steam",
            },
            look_pose="play",
        ),
    ],
...
_ADVANCED_MATTER = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_vapor", "scene": "compare", "picture": "🌦️",
                "question": "What comes after a rain puddle warms?",
                "left_name": "Water vapor rises", "right_name": "Ice forms",
                "left_pic": "♨️", "right_pic": "🧊",
                "left_move": "steam", "right_move": "still",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_hard", "scene": "compare", "picture": "🏺",
                "question": "Which one gets harder?",
                "left_name": "Baked clay", "right_name": "Wet clay",
                "left_pic": "🏺", "right_pic": "🥣",
                "left_move": "still", "right_move": "splash",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_holds_shape", "scene": "compare", "picture": "🧱",
                "question": "Which keeps its own shape?",
                "left_name": "Wood block", "right_name": "Juice",
                "left_pic": "🧱", "right_pic": "🧃",
                "left_move": "still", "right_move": "splash",
            },
            look_pose="play",
...
_ADVANCED_LIVING = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_cycle", "scene": "first_then_next", "picture": "🐣",
                "question": "What comes after an egg?",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_night", "scene": "compare", "picture": "🦉",
                "question": "Which animal is awake at night?",
                "left_name": "Owl", "right_name": "Butterfly",
                "left_pic": "🦉", "right_pic": "🦋",
                "left_move": "bob", "right_move": "still",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_pale", "scene": "compare", "picture": "🪴",
                "question": "Plant is pale. What should change?",
                "left_name": "Give light", "right_name": "Hide in dark",
                "left_pic": "☀️", "right_pic": "🌑",
                "left_move": "grow", "right_move": "still",
            },
            look_pose="play",
...
_ADVANCED_MAKE = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_triangle", "scene": "compare", "picture": "🔺",
                "question": "Which shape makes a strong frame?",
                "left_name": "Triangle", "right_name": "Wobbly curve",
                "left_pic": "🔺", "right_pic": "〰️",
                "left_move": "still", "right_move": "wiggle",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_pick_better", "scene": "compare", "picture": "🌉",
                "question": "Which one did better on the test?",
                "left_name": "Bridge A", "right_name": "Bridge B",
                "left_pic": "🌉", "right_pic": "🪵",
                "left_move": "still", "right_move": "wiggle",
            },
            look_pose="play",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_path", "scene": "compare", "picture": "🟠",
                "question": "Gap blocks the marble. Add what?",
                "left_name": "Short bridge", "right_name": "Soft pillow",
                "left_pic": "🌉", "right_pic": "🛏️",
                "left_move": "still", "right_move": "wiggle",
            },
            look_pose="play",
...
_ADVANCED_STEPS = {
    ...
    "scenes": [
        _scene(
            ...
            look_scene={
                "id": "lesson_debug", "scene": "missing_step", "picture": "🐞",
                "question": "Robot turns wrong. What should change?",
                "one": "Go", "two": "Wrong turn", "missing": "Fix turn",
                "one_pic": "🤖", "two_pic": "↪️", "missing_pic": "🛠️",
            },
            look_pose="play",
        ),
        _scene(
            ...
            look_scene={
                "id": "lesson_square", "scene": "do_it_again", "picture": "⬜",
                "question": "Which steps repeat four times?",
        ...
        _scene(
            ...
            look_scene={
                "id": "lesson_wet", "scene": "first_then_next", "picture": "🌧️",
                "question": "The ground is wet. Wear what?",
