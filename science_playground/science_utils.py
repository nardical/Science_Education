...
_BESPOKE_GAMES = {
    ...
    "matter_beginner_solid_or_splash",
    "matter_beginner_hot_or_cold",
    "matter_beginner_melt_or_freeze",
    "living_things_beginner_living_or_not",
    "living_things_beginner_plant_or_animal",
    "living_things_beginner_hungry_or_full",
    "make_test_beginner_will_the_tower_fall",
    "make_test_beginner_ramp_or_wall",
    "make_test_beginner_fit_the_hole",
    "follow_the_steps_beginner_first_then_next",
    "follow_the_steps_beginner_which_step_is_missing",
    "follow_the_steps_beginner_do_it_again",
    "motion_intermediate_who_went_farther",
    "motion_intermediate_speeding_up",
    "motion_intermediate_which_way_does_it_roll",
    "forces_stuff_intermediate_balance_the_seesaw",
    "forces_stuff_intermediate_will_it_slide",
    "forces_stuff_intermediate_stronger_push_wins",
    "light_sound_intermediate_make_a_shadow",
    "light_sound_intermediate_which_is_louder",
    "light_sound_intermediate_echo_or_no_echo",
    "matter_intermediate_ice_to_water",
    "matter_intermediate_same_stuff_new_look",
    "matter_intermediate_mix_or_settle",
    "living_things_intermediate_what_does_it_need",
    "living_things_intermediate_who_eats_what",
    "living_things_intermediate_home_habitat",
    "make_test_intermediate_test_the_bridge",
    "make_test_intermediate_fix_the_ramp",
    "make_test_intermediate_predict_then_try",
    "follow_the_steps_intermediate_three_step_robot",
    "follow_the_steps_intermediate_if_red_then_stop",
    "follow_the_steps_intermediate_repeat_3_times",
    "motion_advanced_steeper_goes_faster",
    "motion_advanced_two_pushes_add_up",
    "motion_advanced_race_the_clock",
    "forces_stuff_advanced_fair_balance",
    "forces_stuff_advanced_rough_vs_smooth_ramp",
    "forces_stuff_advanced_lift_with_a_lever",
    "light_sound_advanced_bigger_block_bigger_shadow",
    "light_sound_advanced_pitch_ladder",
    "light_sound_advanced_light_path_blocked",
    "matter_advanced_water_cycle_pictures",
    "matter_advanced_soft_to_hard",
    "matter_advanced_what_holds_shape",
    "living_things_advanced_life_cycle_order",
    "living_things_advanced_day_and_night_animals",
    "living_things_advanced_help_it_grow",
    "make_test_advanced_stronger_shape",
    "make_test_advanced_two_tests_pick_better",
    "make_test_advanced_build_a_path",
    "follow_the_steps_advanced_debug_the_path",
    "follow_the_steps_advanced_loop_the_square",
    "follow_the_steps_advanced_if_wet_then_boots",
}
...
def remember_choice_order(
    ...
    (heavier/lighter, faster/slower, sink/float), so the correct box stayed
